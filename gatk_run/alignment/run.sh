...
run_processing(){
   ...
   docker run -it --rm -v /share/30t-1/new_alignment/:/share/30t-1/new_alignment/ biocontainers/samtools samtools index /share/30t-1/new_alignment/N402_rmdup_sm.bam
